...
class TestVerifyTools:
    ...
    def test_python_version_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=0, stdout="Python 3.11.5", stderr="")
    ...
    def test_uv_installation_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=0, stdout="uv 0.4.0", stderr="")
    ...
    def test_docker_service_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(
            returncode=0, stdout="Server: Docker Desktop", stderr=""
        )
    ...
    def test_aws_cli_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=0, stdout="aws-cli/2.13.0", stderr="")
    ...
    def test_pulumi_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=0, stdout="v3.80.0", stderr="")
    ...
    def test_github_cli_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(
            returncode=0, stdout="gh version 2.32.0", stderr=""
        )
    ...
    def test_supabase_cli_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=0, stdout="1.68.0", stderr="")
    ...
    def test_pants_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=0, stdout="2.28.0", stderr="")

        result = subprocess.run(["pants", "--version"], capture_output=True, text=True)
    ...
    def test_jq_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=0, stdout="jq-1.6", stderr="")
    ...
    def test_cruft_verification(self, mock_run):
        ...
        mock_run.return_value = Mock(
            returncode=0, stdout="cruft, version 2.15.0", stderr=""
        )

        result = subprocess.run(["cruft", "--version"], capture_output=True, text=True)
    ...
    def test_github_auth_status(self, mock_run):
        ...
        mock_run.return_value = Mock(
            returncode=0, stdout="✓ Logged in to github.com as username", stderr=""
        )
    ...
    def test_version_comparison_logic(self):
        ...
        min_versions = {"python": (3, 11, 0), "pants": (2, 28, 0), "gh": (2, 0, 0)}

        # All should meet minimum requirements
        current_versions = {"python": (3, 11, 5), "pants": (2, 28, 0), "gh": (2, 32, 0)}

        for tool, min_ver in min_versions.items():
            current_ver = current_versions[tool]
            assert (
                current_ver >= min_ver
            ), f"{tool} version {current_ver} below minimum {min_ver}"
